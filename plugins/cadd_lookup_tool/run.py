...
from app.services.cadd_lookup import enrich_annotations_with_cadd
...
def main() -> None:
    ...
    enriched, lookup_performed, matched_count = enrich_annotations_with_cadd(annotations, genome_build_guess)
